 ...
 * </p>
 * <ul>
 *   <li>{@link ch.fhnw.mdt.uForth.impl.WordImpl#getWords <em>Words</em>}</li>
 *   <li>{@link ch.fhnw.mdt.uForth.impl.WordImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WordImpl extends InstructionImpl implements Word
{
  ...
  {
    return UForthPackage.Literals.WORD;
  }
  ...
  public EList<Word> getWords()
  {
    if (words == null)
    {
      words = new EObjectContainmentEList<Word>(Word.class, this, UForthPackage.WORD__WORDS);
    }
    return words;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, UForthPackage.WORD__NAME, oldName, name));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case UForthPackage.WORD__WORDS:
